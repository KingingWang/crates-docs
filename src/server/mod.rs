...
use rust_mcp_sdk::schema::{Icon, IconTheme, InitializeResult, Implementation, ServerCapabilities, ServerCapabilitiesTools, ProtocolVersion};
use std::sync::Arc;
...
impl CratesDocsServer {
    ...
    pub fn server_info(&self) -> InitializeResult {
        InitializeResult {
            ...
            instructions: Some("使用此服务器查询 Rust crate 文档。支持查找 crate、搜索 crate 和健康检查。".to_string()),
            meta: None,
        }
    }
